...
class RegisterWithFb extends StatefulWidget {
  final Function toggleView;
  const RegisterWithFb({Key? key, required this.toggleView}) : super(key: key);

  @override
  _RegisterWithFbState createState() => _RegisterWithFbState();
}

class _RegisterWithFbState extends State<RegisterWithFb> {
